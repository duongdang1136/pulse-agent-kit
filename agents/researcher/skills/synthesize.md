...
version: 1.0.0
agent: researcher
inputs: [research_question, research_plan, rag_results, web_results, github_results, community_results, project_sources]
...
6. Render the configured Research Report template for ITBA handoff.
